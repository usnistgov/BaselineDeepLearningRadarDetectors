...
def create_full_spectro_dataset(outputFile,infoFileNames,fileNames,waveform_vars,status_vars):
    ...
    sigLen=800000
    spectrotDim=int((sigLen-NOverlap)//(NPerSeg-NOverlap))
